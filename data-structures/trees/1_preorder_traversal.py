"""
Complete the preOrder function in your editor below, which has one parameter: a pointer to the root of a binary tree.
...
def preOrder(root):
    """
    On preorder trasversal we go root > left > right
    """
    if root:
